...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 19 août 2020 à 13:43
...
INSERT INTO `produit` (`id`, `nom`, `reference`, `categorie_id`, `date_achat`, `fin_garantie`, `prix`, `conseils_entretien`, `ticket`, `manuel_utilisation`, `adresse`, `ville`, `cp`, `url`) VALUES
(1, 'ROWENTA X-PERT 160', 'RH7221WO', 1, '2020-07-05', '2021-07-05', 170.42, 'nettoyer le filtre après chaque utilisation', 'produit/ticket/RH7221WO.pdf', '', 'Boulanger chateaufarine', 'Besançon', '', ''),
...
(23, 'Micro-onde Whirpool', 'LM826 BV', 1, '2020-08-19', '2020-08-19', 2, '-ne pas couvrir l\'aeration', 'produit/ticket/LM826 BV.pdf', '', '44 rue marmotte', 'Ankh Morpok', '', '');
