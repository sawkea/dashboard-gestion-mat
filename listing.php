...
if(!isset($_POST['search'])&& !isset($_POST['submit'])){
    foreach($resultat as $ligne){
        echo '<tr>';
            ...
            echo '<td><a class="btn btn-outline-success marge-d pos-r" href="edit.php?edit=1&id='.$ligne['id'].'"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger btn_delete pos-r" href="delete.php?id='.$ligne['id'].'" ><i class="fas fa-trash-alt"></i></a></td>';
        echo '</tr>';
    }
